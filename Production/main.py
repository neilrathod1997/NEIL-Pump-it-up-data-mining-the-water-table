...
cat_col = ['funder', 'installer', 'basin', 'extraction_type', 'extraction_type_class', 'payment_type', 'water_quality', 'quantity', 'source', 'waterpoint_type', 'scheme_management', 'season', 'region_district', 'authority_scheme']
...
clf = load('LGBM_voting.joblib')

# predict
clf.fit(data,Y)
test_pred = clf.predict(test_data)

sub = pd.DataFrame(test_pred, columns=['status_group'])
